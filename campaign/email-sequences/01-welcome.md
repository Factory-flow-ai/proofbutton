...
**Subject Line:** You're one of the first to hear about ProofButton
**Preview Text:** The button that proves accountability — coming soon
...
Thanks for joining us. You're officially one of the first people to hear about ProofButton — "The Accountability Button."

Here's the thing: accountability has always been a pain. "Did you take your medicine?" "I don't know, did you do your chores?" "Who finished the last roll of toilet paper?" These aren't conversations — they're arguments waiting to happen.

ProofButton changes that. It's a self-powered wireless button. No batteries. No charging. No excuses. Press it, and you get proof.

**But what does a button have to do with accountability?**
...
The hardware is ready. The factory is ready. We're launching on Kickstarter very soon, and we're only asking early supporters to help us fund the first consumer production run.

You're going to see three things from us between now and launch:

1. The medicine story (why we built this)
2. Ten different ways to use ProofButton
3. Why you can trust us to deliver

Then we're going live. And you'll have the chance to be one of the first to own it.

**Stay tuned, [FIRST_NAME]. Something good is coming.**
